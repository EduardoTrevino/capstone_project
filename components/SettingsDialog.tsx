...
export default function SettingsDialog({
  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose() }}>
      ...
      >
        <DialogHeader>
          <DialogTitle className="text-white font-dashboard">Profile Settings</DialogTitle>
          <DialogDescription className="text-white font-dashboard">
        ...
        <div className="flex items-center space-x-4 my-4">
          ...
          <div>
            <p className="text-lg font-semibold text-white font-dashboard">
              Hello, {username}!
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <p className="font-semibold mb-1 text-white font-dashboard">Language</p>
          ...
          <div>
            <p className="font-semibold mb-1 text-white font-dashboard">Audio</p>
            {/* Only the icon is clickable for Audio */}
