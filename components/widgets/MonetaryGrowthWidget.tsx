  ...
  return (
    <section className="relative w-full bg-[#FEEED0] border-2 border-[#A03827] rounded-2xl mx-auto py-8">
      ...
      <div className="absolute -top-9 left-1/2 -translate-x-1/2 w-max">
        <Image
          src="/assets/Business/Monetary Growth/Business_Monetary Growth_Title.svg"
          alt="title"
          width={320}
          height={48}
        />
      ...
      <div className="absolute top-6 left-6 flex items-center gap-1 z-10">
        <Image
          ...
          height={24}
        />
        <span className="text-lg font-bold text-[#B22335]">
          {total.toLocaleString()}
        </span>
      </div>

      {/* chart */}
      <div className="relative pt-12 pb-4 w-full h-[220px]">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
            ...
            <YAxis domain={[0, yMax]} interval="preserveStartEnd" tick={{ fill: "#61412C", fontSize: 10 }} tickLine={false} axisLine={false} tickFormatter={(v) => (v === 0 ? "" : v)} />
