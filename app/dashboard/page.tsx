...
export default function DashboardPage() {
  ...
  const [cash] = useState(4654); // ₹ demo – now shown in MonetaryGrowthWidget
  ...
  return (
    <main
      ...
      style={{
        background:
          "url('/assets/Background/PNG/Fixed Background.png') center / cover",
      }}
    >
      {/* =========================== HEADER ============================ */}
      <header className="relative pt-4 pb-2 px-4">
        ...
        >
          <Image
            src="/assets/Log/Log_Icon/Log_Icon.png"
            alt="Log"
            fill
        ...
        <div className="flex justify-center mt-2 gap-1">
          {Array.from({ length: 5 }).map((_, i) => (
            <Image
              key={i}
              src="/assets/Business/Lives/heart.svg"
              alt="heart"
              width={28}
              height={28}
            />
        ...
        <div className="mx-auto mt-2 w-full max-w-[600px] px-4 py-2 bg-[#FEEED0] rounded-xl border-2 border-[#A03827] shadow-lg flex items-center gap-3 relative z-10">
          ...
          <div className="flex-1 h-3 bg-white/40 rounded-full overflow-hidden">
            <div
              className="h-full bg-[#CF7F00] transition-all duration-500"
              style={{ width: `${goalPct}%` }}
            />
          </div>
          <button onClick={() => setShowGoalDialog(true)}>
            <Image
              src="/assets/Goals/Goals_Progress Bar/Editpen.svg"
              alt="edit"
              width={20}
              height={20}
            />
      ...
      <nav className="fixed bottom-0 inset-x-0 z-50">
        <div className="relative h-[95px] bg-white rounded-t-[32px] flex items-center justify-around px-6">
          ...
          >
            <Image
              src="/assets/Navbar/Navbar_Personal Icons/Navbar_Personal Icons_Clicked/Navbar_Personal Icons_Clicked.png"
              alt="home"
              width={48}
              height={48}
            />
          ...
          <div className="relative -top-5">
            ...
            >
              <Image
                src="/assets/Navbar/Navbar_GameButton/Navbar_GameButton.png"
                alt="game"
                fill
                style={{ objectFit: "contain" }}
              />
          ...
          >
            <Image
              src="/assets/Navbar/Navbar_Business Icons/Navbar_Business Icons_Clicked/Navbar_Business Icons_Clicked.png"
              alt="biz"
              width={48}
              height={48}
            />
